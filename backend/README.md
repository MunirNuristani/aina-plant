...
| Status | Meaning                                                                                                                                                                            |
| ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `201`  | New reading stored. Body: `{ "readingId": "...", "status": "created" }`                                                                                                            |
| `200`  | Same `readingId` already stored for this device — see "Retries and duplicates" below. Body: `{ "readingId": "...", "status": "duplicate" }`                                        |
